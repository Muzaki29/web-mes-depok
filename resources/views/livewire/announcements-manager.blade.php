<div>
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-2">
            <input type="text" wire:model.live="search" placeholder="Search announcements..." class="px-3 py-2 rounded-md border border-gray-300">
        ...
        <x-button wire:click="create">New Announcement</x-button>
    </div>
    <x-table>
        <x-slot:head>
            <tr>
